...
man_pages = [
    # CLI
    ('proxmox-offline-mirror/man1', 'proxmox-offline-mirror', 'Command line tool for managing offline repositories and keys.', [author], 1),
    ('proxmox-offline-mirror-helper/man1', 'proxmox-offline-mirror-helper', 'Command line tool for managing offline Proxmox systems.', [author], 1),
    # configs
